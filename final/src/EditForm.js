                                ...
                                <div id = "pl">
                                        <form>
                                                        ...
                                                        <div>
                                                                <div>
                                                                        <div>
                                                                                ...
                                                                                <div>
                                                                                        <input type="text" onChange={handleOnChange} name="professorFirst" required />
                                                                                </div>
                                                                        </div>
                                                                        <div class="field">
                                                                                <label for="professorLast1" class="label">Professor's Last Name:</label>
                                                                                <div class="control">
                                                                                        <input type="text" onChange={handleOnChange_2} name="professorLast" required />
                                                                                </div>
                                                                        </div>
                                                                        <div class="field">
                                                        ...
                                                        <div class="control">
                                                                <div class="rating">
                                                                        ...
                                                                        <div class="ratingButtons">
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_4} id="rating1" name="rating" value="1" required />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_4} id="rating2" name="rating" value="2" />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_4} id="rating3" name="rating" value="3" />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_4} id="rating4" name="rating" value="4" />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_4} id="rating5" name="rating" value="5" />
                                                                        </div>
                                                                        <div class="ratinglabels">
                                                                                <label for="rating1" class="radioLabel">1</label>
                                                                                <label for="rating2" class="radioLabel">2</label>
                                                                                <label for="rating3" class="radioLabel">3</label>
                                                                                <label for="rating4" class="radioLabel">4</label>
                                                                                <label for="rating5" class="radioLabel">5</label>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                        ...
                                                        <div class="control">
                                                                <div class="diff">
                                                                        ...
                                                                        <div class="diffButtons">
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_5} id="diff1" name="diff" value="1" required />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_5} id="diff2" name="diff" value="2" />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_5} id="diff3" name="diff" value="3" />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_5} id="diff4" name="diff" value="4" />
                                                                                <input type="radio" class="radioButton" onChange={handleOnChange_5} id="diff5" name="diff" value="5" />
                                                                        </div>
                                                                        <div class="difflabels">
                                                                                <label for="diff1" class="radioLabel">1</label>
                                                                                <label for="diff2" class="radioLabel">2</label>
                                                                                <label for="diff3" class="radioLabel">3</label>
                                                                                <label for="diff4" class="radioLabel">4</label>
                                                                                <label for="diff5" class="radioLabel">5</label>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                        ...
                                                        <div class="control">
                                                                <div class="retake">
                                                                        ...
                                                                        <div class="retakeButtons">
                                                                                <input type="radio" class="radioButton2" onChange={handleOnChange_6} id="retakeYes" name="retake" value="Yes" required />
                                                                                <input type="radio" class="radioButton2" onChange={handleOnChange_6} id="retakeNo" name="retake" value="No" />
                                                                        </div>
                                                                        <div class="retakelabels">
                                                                                <label for="retakeYes" class="radioLabel">Yes</label>
                                                                                <label for="retakeNo" class="radioLabel">No</label>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                        ...
                                                        <div class="control">
                                                                <div class="book">
                                                                        ...
                                                                        <div class="bookButtons">
                                                                                <input type="radio" class="radioButton2" onChange={handleOnChange_7} id="bookYes" name="book" value="Yes" />
                                                                                <input type="radio" class="radioButton2" onChange={handleOnChange_7} id="bookNo" name="book" value="No" />
                                                                        </div>
                                                                        <div class="bookLabels">
                                                                                <label for="bookYes" class="radioLabel">Yes</label>
                                                                                <label for="bookNo" class="radioLabel">No</label>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                        ...
                                                        <div class="control">
                                                                <div class="attend">
                                                                        ...
                                                                        <div class="attendButtons">
                                                                                <input type="radio" class="radioButton2" onChange={handleOnChange_8} id="attendYes" name="attend" value="Yes" />
                                                                                <input type="radio" class="radioButton2" onChange={handleOnChange_8} id="attendNo" name="attend" value="No" />
                                                                        </div>
                                                                        <div class="attendLabels">
                                                                                <label for="attendYes" class="radioLabel">Yes</label>
                                                                                <label for="attendNo" class="radioLabel">No</label>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="field">
                                                        <div class="control">
                                                                <div class="grade">
                                                                        <h4 class="label">What grade did you recieve? <em>(Optional)</em></h4>
                                                                        <div class="control">
                                                                                <div class="select">
                                                ...
                                                <div class="control">
                                                        ...
                                                        <input type="submit" class="button is-light" value="Cancel" onClick={createCancel} />
                                                </div>
                                        </form>
                                </div>
                        </div>
